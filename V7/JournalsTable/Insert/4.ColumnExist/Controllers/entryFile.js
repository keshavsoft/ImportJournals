...
let postFilterDataFromBodyFunc = (req, res) => {
	...
	let LocalCoumnKS_Date = LocalRequestBody.KS_Date;

    let LocalFromRepo = postDefaultFuncFromRepo({LocalCoumnKS_Date,LocalCoumnDate,LocalCoumnNarration,LocalCoumnChqRefNo,LocalCoumnValueDt,LocalCoumnWithdrawalAmt,LocalCoumnDepositAmt});
