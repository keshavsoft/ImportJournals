...
const StartFunc = ({ }) => {
  ...
  let LocalinDataToInsert = {KS_Date : LocalCoumnKS_Date,Date : LocalCoumnDate,Narration : LocalCoumnNarration,ChqRefNo : LocalCoumnChqRefNo,ValueDt : LocalCoumnValueDt,WithdrawalAmt : LocalCoumnWithdrawalAmt,DepositAmt : LocalCoumnDepositAmt};
